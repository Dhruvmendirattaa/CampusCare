...
//   useEffect(() => {
//     // Trigger only when accessing protected route, not on logout
...
//   // Hide StudentNavbar on /forms page
//   const hideStudentNavbar = location.pathname === "/forms";
...
//         <StudentNavbar />
//       ) : (
//         role !== "student" && role !== "teacher" && <Navbar />
//       )}
...
//           {/* 🔒 Personalize Your Experience (Forms) */}
//           <Route
//             path="/forms"
//             element={
...
function AppContent() {
  ...
  const hideStudentNavbar = role === "student" && location.pathname === "/Forms";
